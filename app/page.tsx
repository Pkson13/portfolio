        ...
        <div id="smooth-content">
          <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
            ...
            <div className="relative mx-auto max-w-4xl text-center">
              ...
              <h1
                className={
                  "mb-6 text-4xl leading-tight font-bold text-gray-900 md:text-6xl lg:text-7xl dark:text-gray-100" +
                  " " +
              ...
              <div className="mx-auto mb-8 max-w-2xl rounded-lg border border-emerald-500/30 bg-black p-4 text-left font-mono dark:bg-gray-800/50">
                ...
                <div className="mt-1 text-gray-300 sm:text-base">
            ...
            <div className="relative mx-auto max-w-6xl">
              ...
              <div className="space-y-20">
                ...
                >
                  ...
                  >
                    <h4
                      className={`mb-4 font-(family-name:--font-bebas-neue) text-2xl font-bold tracking-wide text-gray-900 dark:text-white`}
                    >
                      Video Share
                    </h4>
                ...
                >
                  ...
                  <div className="col-span-1 place-content-center items-center">
                    <h4
                      className={`mb-4 text-2xl font-bold text-gray-900 dark:text-white ${poppinsFont.className}`}
                    >
                      Security Dashboard
                    </h4>
                    <p className="mb-6 leading-relaxed text-gray-600 dark:text-gray-300">
