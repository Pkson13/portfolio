        ...
        <div id="smooth-content" className="max-w-screen">
          <div className="relative max-w-screen overflow-hidden overflow-x-hidden px-4 py-20 sm:px-6 lg:px-8">
            ...
            /> */}
                ...
                <div className="absolute top-40 right-5 h-16 w-16 rounded-full md:right-20">
                  <svg
                    width="100%"
                    height="100%"
                    ...
                    id="react-logo"
                    xmlns="http://www.w3.org/2000/svg"
                    className="uwu-hidden me-0 mt-4 mb-3 flex w-24 origin-center self-center text-sm text-[#58c4dc] transition-all ease-in-out lg:w-28"
                  >
          ...
          >
            {/* Background Pattern */}
            <div className="absolute inset-0">
              <div className="absolute top-20 right-10 h-20 w-32 rotate-45 rounded-lg">
                <svg
                  width="1102"
                  height="278"
                ...
                >
                  ...
                  >
                    ...
                    <p className="mb-6 leading-relaxed text-gray-600 dark:text-gray-300">
                      ...
                      colors, wheels, lights, and more in real-time. Bring your
                      vision to life with interactive, high-fidelity rendering.
                    </p>
                    <div className="mb-6 flex gap-3">
                      <Button
                        size="sm"
