...
const Navbar = () => {
  return (
    <nav className="sticky top-2 left-0 flex w-full items-center gap-3 rounded-2xl p-2 font-(family-name:--font-bebas-neue) text-lg tracking-wide sm:p-2">
      ...
      <div className="ml-auto flex items-center gap-1 sm:ml-1 sm:gap-2">
        <Button asChild variant={"ghost"} className="p-0">
          ...
          >
            {/* <Image src/> */}
            <svg viewBox="0 0 438.549 438.549" className="size-7">
              <path
                fill="currentColor"
